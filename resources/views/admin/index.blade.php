  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav" style="margin-left: 550px;">
      <li class="nav-item active" >
        <a class="nav-link" href="admin" >Beranda<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active" style="margin-left: 10px;">
        <a class="nav-link" href="req-pelanggan">Permintaan Pelanggan</a>
      </li>
      <li class="nav-item active" style="margin-left: 10px;">
        <a class="nav-link" href="req-mitra">Permintaan Mitra</a>
      </li>
      <li>
        <a href="" class="btn btn-outline-primary my-2 my-sm-0" style="margin-left: 55px;">Logout</a>
      </li>
    </ul>
  </div>
</nav>
