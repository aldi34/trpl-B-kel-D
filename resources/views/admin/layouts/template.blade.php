...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="admin/dist/img/twidologo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Admin TWIDO</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="lihatwisata" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/paket-wisata" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/data-mitra" class="nav-link">
