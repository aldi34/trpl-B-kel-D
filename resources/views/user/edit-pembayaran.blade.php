...
<div class="ml-2 col-sm-6">
  <div id="msg"></div>
  <form method="post" id="image-form" action="{{url('edit-bukti-bayar')}}" enctype="multipart/form-data">
    @csrf
    ...
    <button type="submit" class="btn btn-primary">Edit Bukti</button>
  </form>
</div>
<div class="ml-2 col-sm-6">
  <img src="../foto_pembayaran/{{$pesanan->bukti_bayar}}" id="preview" class="img-thumbnail">
</div>
</div>
</div>
