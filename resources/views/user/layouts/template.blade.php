...
<html>
<head>
  <title>Trip Wisata Indonesia</title>

  @yield('link')

  <!-- Icons font CSS-->
    <link href="{{asset('date/vendor/mdi-font/css/material-design-iconic-font.min.css')}}" rel="stylesheet" media="all">
    <link href="{{asset('date/vendor/font-awesome-4.7/css/font-awesome.min.css')}}" rel="stylesheet" media="all">
    <!-- Font special for pages-->
    <link href="https://fonts.googleapis.com/css?family=Roboto:100,100i,300,300i,400,400i,500,500i,700,700i,900,900i" rel="stylesheet">

    <!-- Vendor CSS-->
    <link href="{{asset('date/vendor/select2/select2.min.css')}}" rel="stylesheet" media="all">
    <link href="{{asset('date/vendor/datepicker/daterangepicker.css')}}" rel="stylesheet" media="all">

    <!-- Main CSS-->
    <link href="{{asset('date/css/main.css')}}" rel="stylesheet" media="all">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="user-home">TWIDO</a>
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active" style="color: #fff">
        Trip Wisata Indonesia
      </li>
    </ul>
    <span class="navbar-text">
      <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="user-home">Beranda</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="mulai-trip">Beli Paket</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="{{url('/pesanan-anda')}}">Pesanan Anda</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="#">Transaksi</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{url('/logout')}}">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Log Out</a>
      </li>
      </ul>
    </span>
  </div>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
    ...
    <!-- Jquery JS-->
    <script src="{{asset('date/vendor/jquery/jquery.min.js')}}"></script>
    <!-- Vendor JS-->
    <script src="{{asset('date/vendor/select2/select2.min.js')}}"></script>
    <script src="{{asset('date/vendor/datepicker/moment.min.js')}}"></script>
    <script src="{{asset('date/vendor/datepicker/daterangepicker.js')}}"></script>

    <!-- Main JS-->
    <script src="{{asset('date/js/global.js')}}"></script>
